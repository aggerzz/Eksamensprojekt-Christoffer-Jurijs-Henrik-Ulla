...
public class RKIAccess extends Thread {
	...
	public void getKreditværdighed() {
		...
		case A:
			låneanmodning.kreditværdighed = 'A';
			break;
		case B:
			låneanmodning.kreditværdighed = 'B';
			break;
		case C:
			låneanmodning.kreditværdighed = 'C';
			break;
		case D:
			låneanmodning.kreditværdighed = 'D';
			break;
		default:
			låneanmodning.kreditværdighed = 'X';
